...
function removeJspmInjections (source: MagicString, els: ParsedTag[]) {
  for (const el of els) {
    if (el.name === 'script') {
...
function renderScript (script: Script, type?: string) {
...
export function inject (html: string, injection: Injection): string {
